    ...
    <div className="reader-browser">
      ...
      <section className="reading-activity-panel" ref={panelRef} tabIndex={-1} aria-live="polite">
        {selected ? <>
          ...
          <div className="button-row"><Link className="button primary" to={`/lesson/${selected.sectionId}`}>Open assigned lesson</Link><button type="button" onClick={() => setSearchParams({})}>Close activity</button></div>
